...
INSERT INTO public.appointments VALUES (6, 7, 1, '10:30');
...
SELECT pg_catalog.setval('public.appointments_appointments_id_seq', 27, true);
...
SELECT pg_catalog.setval('public.services_services_id_seq', 10, true);
